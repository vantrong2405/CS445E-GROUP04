...
namespace ArtAuctionManage.DataAccess.Migrations
{
    /// <inheritdoc />
    public partial class CreateAndSeedData_CompaniesTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Tech City", "Tech Solution", "0938273645", "48291", "IL", "123 Tech St" },
                    { 2, "Vid City", "Vivid Books", "0965128390", "23958", "IL", "999 Vid St" },
                    { 3, "Lala land", "Readers Club", "0917465283", "71924", "NY", "999 Main St" }
                });
        }
