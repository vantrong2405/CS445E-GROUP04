...
{
    [DbContext(typeof(ArtAuctionManageDbContext))]
    [Migration("20240912045405_UpdatePaymentTypeField_OrderHeadersTable")]
    partial class UpdatePaymentTypeField_OrderHeadersTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ArtAuctionManage.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ArtAuctionManage.Models.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ArtAuctionManage.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ArtAuctionManage.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ArtAuctionManage.Models.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ArtAuctionManage.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ArtAuctionManage.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("ArtAuctionManage.Models.OrderDetail", b =>
                {
                    b.HasOne("ArtAuctionManage.Models.OrderHeader", "OrderHeader")
                        .WithMany()
                        .HasForeignKey("OrderHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ArtAuctionManage.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("ArtAuctionManage.Models.OrderHeader", b =>
                {
                    b.HasOne("ArtAuctionManage.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("ArtAuctionManage.Models.Product", b =>
                {
                    b.HasOne("ArtAuctionManage.Models.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("ArtAuctionManage.Models.ApplicationUser", b =>
                {
                    b.HasOne("ArtAuctionManage.Models.Company", "Company")
                        .WithMany()
