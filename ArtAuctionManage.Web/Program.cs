...
using ArtAuctionManage.DataAccess.Repositories;
...
using ArtAuctionManage.DataAccess.DbInitializer;

namespace ArtAuctionManage.Web
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddDbContext<ArtAuctionManageDbContext>(options =>
            {
                options.UseSqlServer(builder.Configuration.GetConnectionString("DefaultConnection"));
            });

            builder.Services.AddIdentity<IdentityUser, IdentityRole>
                (options => options.SignIn.RequireConfirmedAccount = false).AddEntityFrameworkStores<ArtAuctionManageDbContext>()
